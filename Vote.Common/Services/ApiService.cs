namespace Vote.Common.Services
{
    ...
    public class ApiService
    {
        ...
        public async Task<Response> GetVoteEventByIdAsync<T>(
            string urlBase,
            string servicePrefix,
            string controller,
            T model,
            ...
            string accessToken)
        {
            try
            {
                ...
                var obj = JsonConvert.DeserializeObject<VoteEvent>(answer);
                return new Response
                {
                    IsSuccess = true,
                    Result = obj,
        ...
        public async Task<Response> GetAlreadyVotedAsync<T>(
            string urlBase,
            string servicePrefix,
            string controller,
            T model,
            ...
            string accessToken)
        {
            try
            {
                ...
                var obj = JsonConvert.DeserializeObject<Candidate>(answer);
                return new Response
                {
                    IsSuccess = true,
                    Result = obj,
        ...
        public async Task<Response> GetCandidatesAsync<T>(
            string urlBase,
            string servicePrefix,
            string controller,
            T model,
            ...
            string accessToken)
        {
            try
            {
                ...
                var obj = JsonConvert.DeserializeObject<List<Candidate>>(answer);
                return new Response
                {
                    IsSuccess = true,
                    Result = obj,
